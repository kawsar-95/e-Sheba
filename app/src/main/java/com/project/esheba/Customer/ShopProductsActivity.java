...
public class ShopProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Company Services");

        whorlView = (WhorlView) this.findViewById(R.id.whorl2Shop);
        whorlView.start();
        // progressBar = findViewById(R.id.progressBar);
        recyclerView = findViewById(R.id.recyclerShop);
        imgNoProductCH = findViewById(R.id.image_no_productShop);

        cell = getIntent().getExtras().getString("getcell");
        ...
        call.enqueue(new Callback<List<ProductCH>>() {
            ...
            public void onResponse(Call<List<ProductCH>> call, Response<List<ProductCH>> response) {
                ...
                if (productList.size() == 0) {
                    imgNoProductCH.setVisibility(View.VISIBLE);
                    imgNoProductCH.setImageResource(R.drawable.no_product);
                    productAdapter = new ProductAdapterCH(ShopProductsActivity.this, productList);
                    ...
                    imgNoProductCH.setVisibility(View.GONE);
            ...
            public void onFailure(Call<List<ProductCH>> call, Throwable t) {
                //  progressBar.setVisibility(View.INVISIBLE);
                whorlView.setVisibility(View.INVISIBLE);
                Toast.makeText(ShopProductsActivity.this, "Error : " + t.toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
