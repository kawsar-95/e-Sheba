...
public class Constant {
    ...
    //public static final String MAIN_URL = "http://bloodbank24.cf/e_sheba";
    public static final String MAIN_URL = "https://projectsandroid.com/e_sheba";
    //public static final String BASE_URL = "http://bloodbank24.cf/e_sheba/";
    public static final String BASE_URL = "https://projectsandroid.com/e_sheba/";
    //public static final String HOST_URL = "http://bloodbank24.cf/";
    public static final String HOST_URL = "https://projectsandroid.com//";
...
//    public static final String HOST_URL="https://android.nkrit.com/efarmers/";
    ...
    public static final String KEYPDODUCT_ID = "product_id";
    ...
    public static final String KEY_AGV_REVIEW = "AVG(rating)";
   ...
   // public static final String SHARED_PREF_NAME = "com.app.accident.userlogin"; //pcakage name+ id
    public static final String SHARED_PREF_NAME = "com.habibproject.e_sheba.userlogin"; //pcakage name+ id
